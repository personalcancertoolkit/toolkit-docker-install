...
//						}
					...
					echo '<li style="padding-top:0.5em; padding-bottom:0.5em; padding-left:1em; padding-right:1em; margin-top:0.25em;'.$background.'"><a href="'.base_url().'/cancertypes/add">Add New Cancer Type</a></li>';
				?>
